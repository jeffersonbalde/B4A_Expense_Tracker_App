...
//BA.debugLineNum = 33;BA.debugLine="AddMoney.Bottom = 87%Y"[Dashboard/General script]
views.get("addmoney").vw.setTop((int)((87d / 100 * height) - (views.get("addmoney").vw.getHeight())));
...
//BA.debugLineNum = 38;BA.debugLine="AddCash.Bottom = 79%Y"[Dashboard/General script]
views.get("addcash").vw.setTop((int)((79d / 100 * height) - (views.get("addcash").vw.getHeight())));
...
//BA.debugLineNum = 45;BA.debugLine="ListView1.Width = 80%X"[Dashboard/General script]
views.get("listview1").vw.setWidth((int)((80d / 100 * width)));
//BA.debugLineNum = 46;BA.debugLine="ListView1.Height = 46%Y"[Dashboard/General script]
views.get("listview1").vw.setHeight((int)((46d / 100 * height)));
//BA.debugLineNum = 47;BA.debugLine="ListView1.Left = 10%X"[Dashboard/General script]
views.get("listview1").vw.setLeft((int)((10d / 100 * width)));
//BA.debugLineNum = 48;BA.debugLine="ListView1.Bottom = 70%Y"[Dashboard/General script]
views.get("listview1").vw.setTop((int)((70d / 100 * height) - (views.get("listview1").vw.getHeight())));
